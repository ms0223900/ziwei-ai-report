...
- [x] US-021 grant 與付款互動 測試
- [x] US-022 grant 與付款互動 實作
- [x] US-023 plan_id 履約分流接點說明
...
- 已掃描至：US-023（2026-09-19）
- 已知待觀察熱點：無
- 備註：US-023 窗：SOP 文件＋webhook 兩行掛點註解。無 churn hotspot。低風險，暫不重構。
