...
### Phase 3 — 建單閘門
- [x] US-008 月繳建單與閘門 測試（預期紅燈；待實作轉綠）
- [x] US-009 月繳建單與閘門 實作
...
- [x] US-013 PeriodReturnURL 實作

### Phase 6 — 權限判斷
- [x] US-014 權益判斷與進階 GET 測試（預期紅燈；待實作轉綠）
- [x] US-015 權益判斷與進階 GET 實作

### Phase 7 — 視圖與畫面
- [x] US-016 會員視圖訂閱態 測試（預期紅燈；待實作轉綠）
- [x] US-017 會員視圖訂閱態 實作
- [x] US-018 首頁訂閱接線與月繳入口
- [x] US-019 移除追問文案與入口
