...
- [x] US-025 maxDuration 與機密不外洩

## 重構掃描記錄

- 已掃描至：US-025（2026-09-09）
- 已知待觀察熱點：
  ...
  - `app/api/reports/route.ts`（US-018／US-024 疊 Live 分支；本次窗未再改）
- 備註：US-025 只動 `vercel.json`、文件與掃描測試。無反模式達重構門檻。低風險，暫不重構。
